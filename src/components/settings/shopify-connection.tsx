        ...
        <div className="space-y-1">
          ...
          <div className="flex flex-col gap-2 sm:flex-row">
            ...
            <a
              ...
              className={`rounded-lg bg-primary px-4 py-2 text-center font-display text-sm font-medium text-white transition-colors hover:bg-primary-dark ${!shopDomain ? "pointer-events-none opacity-50" : ""}`}
            >
              Connect
            </a>
          </div>
