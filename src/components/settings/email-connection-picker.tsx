...
import type { EmailAddress, EmailConnection } from "@/lib/types/database";

type ConnectionMethod = "webhook" | "oauth";
          ...
          {activeConnection ? (
            ...
            <div className="space-y-3">
              <p className="text-sm text-zinc-500 dark:text-zinc-400">
                Connect your email account to receive and send emails directly through Envoyer. No DNS configuration needed.
              </p>
